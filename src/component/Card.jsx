...
function Card({src,title,text,stack,url,github,vw}) {
  return (
    vw>1520?
    <div className="card w-[400px] 2xl:w-[500px] shadow-xl mt-6 hover:grayscale-0 grayscale hover:scale-110">
        <figure><img  className='h-[250px]' src={src} alt="Shoes" /></figure>
        <div className="card-body bg-base-400 p-3 text-white font-Inter">
            <div className='text-3xl text-center font-bold cursor-pointer underline'><a href={url} target="_blank">{title}</a></div>
            <p>{text}</p>
    ...
    <div className="flip-box w-[300px] h-[200px] lg:w-[400px] lg:h-[250px] mt-4 xl:w-[450px] xl:h-[270px]">
